    ...
    <script>
        $(document).ready(function () {
            function getPaymentHistory() {
                ...
                $.ajax({
                    type:'POST',
                    url:'/teacher-receivables/payment-history/filter',
                    data: {school_id:school_id,teacher_id:teacher_id,account_id:account_id},
                    dataType: 'json',
            ...
            $('#school_id,#teacher_id').on('change', function () {
                getPaymentHistory();
            });
            ...
            $('#income_account_id').on('change', function () {
                ...
                if (selectedText.includes('infaq guru')) {
                    $('#persen_bayar').val(1);
