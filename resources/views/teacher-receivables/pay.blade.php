...
@section('content')
	...
	<div class="app-hero-header d-flex align-items-start">
	    ...
	    <ol class="breadcrumb">
			...
			<li class="breadcrumb-item" aria-current="page">Piutang Guru - Bayar</li>
		</ol>
		<!-- Breadcrumb end -->
	</div>
		...
		<div class="row gx-3">
			<div class="col-xl-12">
				<div class="card mb-3">
					...
					<div class="card-body">
                        <p><strong>Guru:</strong> {{ $receivable->teacher->name }} ({{ $receivable->teacher->teacher_id_number }})</p>
                        ...
                        @endif
                        <form action="{{ route('school-teacher-receivables.pay', [$school, $receivable]) }}" method="POST">
                        @csrf
                            <div class="create-invoice-wrapper">
                                ...
                                <div class="row gx-3">
                                    <div class="col-sm-6 col-12">
                                        <!-- Row start -->
                                        @if($receivable->teacher_receivable_details->isEmpty())
                                            <div class="row gx-3">
