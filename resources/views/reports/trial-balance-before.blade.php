...
@section('content')
    <div class="app-hero-header d-flex align-items-start">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Neraca Saldo Awal</li>
        </ol>
    </div>
                        ...
                        <form method="GET" class="mb-4">
                            ...
                            <div class="row gx-3">
                                <div class="col-xl-4 col-md-6 col-12">
                                    ...
                                    <a href="{{ auth()->user()->role != 'SchoolAdmin' ? route('reports.trial-balance-before') : route('school-reports.trial-balance-before', $school) }}" class="btn btn-danger">Reset</a>
                                    <a href="{{ route('trial-balance-before', array_merge(['school' => $school ? $school->id : request()->query('school_id')], request()->except('school_id'), ['export' => 'excel'])) }}" class="btn btn-success">Export Excel</a>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Neraca Saldo Awal {{ $school ? $school->name : 'Semua Sekolah' }} ({{ \Carbon\Carbon::parse($date)->format('d-m-Y') }})</h5>
                    </div>
                    <div class="card-body">
