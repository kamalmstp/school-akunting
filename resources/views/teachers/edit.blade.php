...
@section('content')
	...
	<div class="app-hero-header d-flex align-items-start">
	    ...
	    <ol class="breadcrumb">
			...
			<li class="breadcrumb-item" aria-current="page">Kelola Guru - Edit</li>
		</ol>
		<!-- Breadcrumb end -->
	</div>
				...
				<div class="card mb-3">
					<div class="card-header">
						<div class="d-flex justify-content-between align-items-center">
							<h5 class="card-title">Edit Guru - {{ $school->name }}</h5>
						</div>
					</div>
					<div class="card-body">
                        <form action="{{ route('school-teachers.update', [$school, $teacher]) }}" method="POST">
                        @csrf
                        @method('PUT')
                                        ...
                                        <div class="row gx-3">
                                            <div class="col-sm-12 col-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('teacher_id_number') is-invalid @enderror" id="teacher_id_number" name="teacher_id_number" value="{{ old('teacher_id_number', $teacher->teacher_id_number) }}">
                                        ...
                                        <div class="row gx-3">
                                            <div class="col-sm-12 col-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik" value="{{ old('nik', $teacher->nik) }}">
                                                    @error('nik')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="row gx-3">
                                            ...
                                            <div class="col-sm-12 col-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('education') is-invalid @enderror" id="education" name="education">
                                                        @php
                                                        $selectedEdu = old('education', $teacher->education ?? '');
                                                        @endphp
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="1950" max="{{ date('Y') }}" class="form-control @error('tmt') is-invalid @enderror" id="tmt" name="tmt" value="{{ old('tmt', $teacher->tmt ?? '') }}">
                                                    @error('tmt')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    $tmtYear = old('tmt', $teacher->tmt ?? null);
                                                    $workPeriod = '';
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('certification') is-invalid @enderror" id="certification" name="certification">
                                                        @php
                                                        $selectedCert = old('certification', $teacher->certification ?? '');
                                                        @endphp
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('employment_status') is-invalid @enderror" id="employment_status" name="employment_status">
                                                        @php
                                                        $selectedStatus = old('employment_status', $teacher->employment_status ?? '');
                                                        @endphp
                                                        <option value="" {{ $selectedStatus == '' ? 'selected' : '' }}>- Pilih -</option>
                                                        <option value="GTY" {{ $selectedStatus == 'GTY' ? 'selected' : '' }}>Guru Tetap Yayasan</option>
                                                        <option value="GTT" {{ $selectedStatus == 'GTT' ? 'selected' : '' }}>Guru Tidak Tetap</option>
                                                    </select>
                                        ...
                                        <div class="row gx-3">
                                            <div class="col-sm-12 col-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $teacher->email) }}">
                                                    @error('email')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="row gx-3">
                                            <div class="col-sm-12 col-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address">{{ old('address', $teacher->address) }}</textarea>
                                                    @error('address')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-sm-12 col-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('is_active') @enderror" id="is_active" name="is_active">
                                                        <option value="1" {{ old('is_active', $teacher->is_active) == true ? 'selected' : '' }}>Aktif</option>
                                                        <option value="0" {{ old('is_active', $teacher->is_active) == false ? 'selected' : '' }}>Tidak Aktif</option>
                                                    </select>
                                                    @error('is_active')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
