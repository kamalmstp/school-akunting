						...
						<ul class="sidebar-menu">
                            @if(auth()->user()->role === 'SuperAdmin')
								...
								<li class="treeview receivable">
                                    ...
                                    <ul class="treeview-menu">
                                        <li>
                                            <a href="{{ route('student-receivables.index') }}" class="p-first">Penerimaan Siswa</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('teacher-receivables.index') }}" class="p-second">Penerimaan Guru</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('employee-receivables.index') }}" class="p-third">Penerimaan Karyawan</a>
                                        </li>
                                    </ul>
                                </li>
