		...
		<div class="row gx-3">
			<div class="col-xl-12">
				<div class="card mb-3">
					...
					<div class="card-body">
                        <form action="{{ route('school-cash-managements.store', $school) }}" method="POST">
                        @csrf
                            ...
                            <div class="row gx-3">
                                <div class="col-12">
                                    <div class="text-start">
                                        ...
                                        <a href="{{ auth()->user()->role == 'SuperAdmin' ? route('cash-managements.index') : route('school-cash-managements.index', $school) }}" class="btn btn-outline-success ms-1">Batal</a>
                                    </div>
                                </div>
                            </div>
                        </form>
