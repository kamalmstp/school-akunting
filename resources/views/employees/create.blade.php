...
@section('content')
	...
	<div class="app-hero-header d-flex align-items-start">
	    ...
	    <ol class="breadcrumb">
			...
			<li class="breadcrumb-item" aria-current="page">Kelola Karyawan - Tambah</li>
		</ol>
		<!-- Breadcrumb end -->
	</div>
				...
				<div class="card mb-3">
					<div class="card-header">
						<div class="d-flex justify-content-between align-items-center">
							<h5 class="card-title">Tambah Karyawan @if(auth()->user()->role == 'SchoolAdmin') - {{ $school->name }} @endif</h5>
						</div>
					</div>
					<div class="card-body">
                        <form action="{{ auth()->user()->role == 'SuperAdmin' ? route('employees.store', $school) : route('school-employees.store', $school) }}" method="POST">
                        @csrf
                                        ...
                                        <div class="row gx-3">
                                            <div class="col-sm-12 col-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('employee_id_number') is-invalid @enderror" id="employee_id_number" name="employee_id_number" value="{{ old('employee_id_number') }}">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('employment_status') is-invalid @enderror" id="employment_status" name="employment_status">
                                                        ...
                                                        <option value="PTY" {{ old('employment_status') == 'PTY' ? 'selected' : '' }}>Pegawai Tetap Yayasan</option>
                                                        <option value="PTT" {{ old('employment_status') == 'PTT' ? 'selected' : '' }}>Pegawai Tidak Tetap</option>
                                                    </select>
